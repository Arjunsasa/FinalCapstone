    ...
    <main>
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-12 col-md-4 mb-5">
            <div class="card w-100 sh-18 sh-md-22 hover-img-scale-up">
              <img src="library/img/product/scheduleThumbnail.jpg" class="card-img h-100 scale" alt="card image" />
              <div class="card-img-overlay d-flex flex-column justify-content-between bg-transparent">
                <div class="d-flex flex-column h-100 justify-content-between align-items-start">
                  <div class="cta-3 text-black">
                    Schedule
                  ...
                  <a href="<?php SITE_ROOT ?>schedule.php" class="btn btn-icon btn-icon-start btn-primary stretched-link">
                    <i data-acorn-icon="chevron-right"></i>
                    <span>View</span>
                  </a>
                </div>
              ...
              <div class="card-body small">
                ...
                <div class="mb-2 cta-3 text-primary small">Need more help?
                  ...
                  <form method="POST" class="small">
                    ...
                    <button type="submit" class="btn btn-primary btn-sm" name="submit-btn">Submit</button>
                  </form>
                  <!-- Enquiry form end -->

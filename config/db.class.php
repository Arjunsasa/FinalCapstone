...
class DB {
  // initial connection
  public static $dbName = 'u219219275_yas'; // DB Name
  public static $user = 'u219219275_yas'; // DB Username for localhost: "root"
  public static $password = 'Password12!'; // DB Password for localhost: "root" or leave it blank
  public static $host = '191.101.230.52';
  public static $port = 3306; // hhvm complains if this is null
  // Port for localhost: 8889
